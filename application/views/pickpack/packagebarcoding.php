							...
							<div class="card-body">
								<div class="row  mr-3">
									<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 d-flex flex-row-reverse">
										<div class="form-group">
											<button class="btn btn-primary" onclick="printPackageBarcode()"><i class="fa fa-print"></i> <?php echo $this->lang->line('print'); ?> </button>
										</div>
									</div>
												...
												<tr> 
													<td colspan="2"><h3>
														...
														foreach($packDetails as $detail) {
															...
															echo '<span class="text-right">'.number_format($detail->qty,2).' '.strtoupper($this->lang->line('units')).'</span></h4>';
														} ?>
														<?php echo '<h3>'.strtoupper($this->lang->line('total_weight')).'<br/>'; ?><br/>
														<?php echo '<span class="text-right">'.number_format($totalWeight,2).' '.strtoupper($this->lang->line('kg')).'</span></h3>';?>
													</td>
												</tr>
												<!-- BARCODE -->
												<tr>
