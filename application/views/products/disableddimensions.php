								...
								<div class="row">
									<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
										...
										<div class="input-group input-group-sm mb-2 mr-sm-2">
											<input type="number" min="0" step="0.01" name="productDim_length" id="productDim_length" value="<?php if ($this->input->post('productDim_products')){ echo $data['productLength']; }?>" class="form-control form-control-sm " disabled placeholder="<?php echo $this->lang->line('package_length'); ?>" REQUIRED>
									...
									<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
										...
										<div class="input-group input-group-sm mb-2 mr-sm-2">
											<input type="number" min="0" step="0.01" name="productDim_width" id="productDim_width" value="<?php if ($this->input->post('productDim_products')){ echo $data['productWidth']; }?>" class="form-control form-control-sm" disabled placeholder="<?php echo $this->lang->line('package_width'); ?>" REQUIRED>
											<div class="input-group-prepend">
												<div class="input-group-text"><?php echo $this->lang->line('cm'); ?></div>
											</div>
										</div>
									...
									<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
										...
										<div class="input-group input-group-sm mb-2 mr-sm-2">
											<input type="number" min="0" step="0.01" name="productDim_height" id="productDim_height" value="<?php if ($this->input->post('productDim_products')){ echo $data['productHeight']; }?>" class="form-control form-control-sm" disabled  placeholder="<?php echo $this->lang->line('package_height'); ?>" REQUIRED>
											<div class="input-group-prepend">
												<div class="input-group-text"><?php echo $this->lang->line('cm'); ?></div>
											</div>
										</div>
									...
									<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
										...
										<div class="input-group input-group-sm mb-2 mr-sm-2">
											<input type="number" min="0" step="0.01" name="productDim_weight" id="productDim_weight" value="<?php if ($this->input->post('productDim_products')){ echo $data['productWeight']; }?>" class="form-control form-control-sm " disabled placeholder="<?php echo $this->lang->line('total_weight'); ?>" REQUIRED>
											<div class="input-group-prepend">
									...
									<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
										...
										<div class="input-group input-group-sm mb-2 mr-sm-2">
											<input type="number" min="0" step="1" name="productDim_units" id="productDim_units" value="<?php if ($this->input->post('productDim_products')){ echo $data['productWeight']; }?>" class="form-control form-control-sm " disabled placeholder="<?php echo $this->lang->line('pallet_units'); ?>" REQUIRED>
											<div class="input-group-prepend">
