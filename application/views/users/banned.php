			<div class="page-header">
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item active"><?php echo $this->lang->line('banned_users'); ?></li>
				</ol>
						...
						<div class="card">
							<div class="card-body">
								<ul class="top-icons pull-right text-info small">
									...
									<li>
										<a href="<?php echo base_url();?>users/list" data-toggle="tooltip" data-placement="top" title="" data-original-title="<?php echo $this->lang->line('banned_users'); ?>">
											<span class="range-text"> <i class="fa fa-user"></i> <?php echo $this->lang->line('all_users'); ?></span>
										</a>
									</li>
									<li>
